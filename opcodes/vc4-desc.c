...
const CGEN_IFLD vc4_cgen_ifld_table[] =
{
  ...
  { VC4_F_OFFSET16, "f-offset16", 16, 16, 15, 16, { 0|A(PCREL_ADDR), { { { (1<<MACH_BASE), 0 } } } }  },
...
/* alu48immu:  */
  { "alu48immu", VC4_OPERAND_ALU48IMMU, HW_H_UINT, 31, 32,
    ...
    { 0|A(RELAX), { { { (1<<MACH_BASE), 0 } } } }  },
/* alu48offset:  */
  { "alu48offset", VC4_OPERAND_ALU48OFFSET, HW_H_SINT, 31, 32,
...
/* mem48offset27:  */
  { "mem48offset27", VC4_OPERAND_MEM48OFFSET27, HW_H_SINT, 26, 27,
    ...
    { 0, { { { (1<<MACH_BASE), 0 } } } }  },
/* mem48pcrel27:  */
  { "mem48pcrel27", VC4_OPERAND_MEM48PCREL27, HW_H_SINT, 26, 27,
...
/* offset16:  */
  { "offset16", VC4_OPERAND_OFFSET16, HW_H_SINT, 15, 16,
    { 0, { (const PTR) &vc4_cgen_ifld_table[VC4_F_OFFSET16] } }, 
    { 0|A(PCREL_ADDR), { { { (1<<MACH_BASE), 0 } } } }  },
/* off16basereg:  */
...
/* ld$accsz32 $alu32dreg,$index16($off16basereg) */
  {
    VC4_INSN_LDOFF16, "ldoff16", "ld", 32,
    { 0, { { { (1<<MACH_BASE), 0 } } } }
  },
/* st$accsz32 $alu32dreg,$index16($off16basereg) */
  {
